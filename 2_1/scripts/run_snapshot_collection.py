...
def main() -> int:
    ...
    parser.add_argument("--min-interval-hours", type=int, default=72, help="同关键词最短间隔，硬下限 72")
    parser.add_argument("--pages-per-keyword", type=int, default=1, help="单关键词默认页数，硬上限 7")
    parser.add_argument("--max-pages-per-keyword", type=int, default=7, help="单关键词页数上限，硬上限 7")
    ...
    parser.add_argument("--page-delay-min", type=int, default=5, help="页间隔最小秒数，硬下限 5（对齐原有 crawl_amazon）")
    parser.add_argument("--page-delay-max", type=int, default=10, help="页间隔最大秒数，默认 10")
    parser.add_argument("--max-runtime-minutes", type=int, default=120, help="单轮最长分钟数，硬上限 120")
    parser.add_argument(
        "--manifest",
